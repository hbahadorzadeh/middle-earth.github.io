...
export const FEATURE_COORDINATE_OVERRIDES: Record<string, Point> = {
  ...
  "amon-sul": { x: 1305, y: 1076 },
  "last-bridge": { x: 1450, y: 1105 },
  rivendell: { x: 1620, y: 1092 },
  tharbad: { x: 1320, y: 1465 },
  moria: { x: 1710, y: 1455 },
  "durins-door": { x: 1678, y: 1450 },
  mirrormere: { x: 1764, y: 1458 },
  "dimrill-dale": { x: 1796, y: 1486 },
  hollin: { x: 1570, y: 1388 },
  caradhras: { x: 1760, y: 1336 },
  "caras-galadhon": { x: 1995, y: 1518 },
  argonath: { x: 2198, y: 1760 },
  "parth-galen": { x: 2190, y: 1870 },
  "amon-hen": { x: 2236, y: 1852 },
  rauros: { x: 2282, y: 1902 },
  isengard: { x: 1700, y: 1846 },
  orthanc: { x: 1704, y: 1842 },
  "treebeards-hall": { x: 1852, y: 1738 },
  wellinghall: { x: 1890, y: 1718 },
  entmoot: { x: 1822, y: 1796 },
  "helms-deep": { x: 1780, y: 2095 },
  edoras: { x: 1988, y: 1986 },
  dunharrow: { x: 2140, y: 2052 },
  "minas-tirith": { x: 2274, y: 2100 },
  "cair-andros": { x: 2355, y: 1978 },
  osgiliath: { x: 2374, y: 2118 },
  "minas-morgul": { x: 2488, y: 2142 },
  "cirith-ungol": { x: 2526, y: 2190 },
  morannon: { x: 2540, y: 1878 },
  "barad-dur": { x: 2702, y: 1940 },
  "mount-doom": { x: 2610, y: 2042 },
  "dead-marshes": { x: 2450, y: 1958 },
  pelargir: { x: 2310, y: 2260 },
  "dol-amroth": { x: 1760, y: 2278 },
  erech: { x: 2038, y: 2192 },
  "dol-guldur": { x: 2070, y: 1420 },
  "woodland-realm": { x: 2198, y: 1032 },
  "beorns-hall": { x: 1960, y: 976 },
  dale: { x: 2480, y: 812 },
  esgaroth: { x: 2470, y: 892 },
  erebor: { x: 2550, y: 770 },
